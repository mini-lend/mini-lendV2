...
const amountNum = parseFloat(amount);
    ...
    try {
      ...
      setResultModal({
        ...
        message:
          "Your ETH collateral has been successfully withdrawn.",
        activity: "Withdraw",
        amount: `${withdrawalAmount} ETH`,
        asset: "ETH",
            ...
            >
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {/* Transaction status */}
                  {isLoading && (
                    <div className="mt-3 flex items-center gap-2 p-2 rounded-lg bg-white/[0.03] border border-white/[0.07]">
                      <div className="w-3.5 h-3.5 border-2 border-[#6DD054] border-t-transparent rounded-full animate-spin" />
