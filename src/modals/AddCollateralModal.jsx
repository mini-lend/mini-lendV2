...
export default function AddCollateralModal({ isOpen, onClose }) {
  ...
  const handleAddCollateral = async () => {
    ...
    try {
      // stakeEth waits until the transaction is confirmed
      const result = await stakeEth(collateralAmount);

      // Refresh position/dashboard data
      handleRefresh();
            ...
            <div className="p-5">
              ...
              <div className="mt-4 flex gap-3 rounded-xl border border-[#6DD054]/10 bg-[#6DD054]/[0.04] p-3">
                ...
                <p className="text-[11px] leading-5 text-white/40">
                  Adding collateral increases your
                  position's safety and allows you to
                  borrow more.
                </p>
              </div>
