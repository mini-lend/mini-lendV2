...
export default function RepayModal({ isOpen, onClose }) {
  ...
  const handleRepay = async () => {
    if (!amount || Number(amount) <= 0 || !debtToken || isLoading) {
      return;
    }
    ...
    try {
      const result = await repayAsset(debtToken, repaymentAmount);
      ...
      setResultModal({
        ...
        message:
          "Your repayment transaction has been successfully completed.",
        activity: "Repay",
  ...
  return (
    <>
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex gap-3 rounded-xl border border-[#6DD054]/10 bg-[#6DD054]/[0.04] p-3">
                    ...
                    <p className="text-[11px] leading-5 text-white/40">
                      Repaying your debt improves your health
                      factor and reduces liquidation risk.
                    </p>
                  </div>
      ...
      {/* One reusable result modal for all activities */}
      <ActivityResultModal
